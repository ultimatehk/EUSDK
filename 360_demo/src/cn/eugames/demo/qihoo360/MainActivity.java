...
public class MainActivity extends Activity {
	...
	public void click(View v){
		...
		case R.id.btn_eugames_logout:
			EUSDKUnify.getInstance().logout(MainActivity.this,
					loginOutListener);
		break;
		...
		case R.id.btn_eugames_real_name:
			EUSDKUnify.getInstance().realNameRegister(userId,new EUSDKListener() {
				@Override
				public void onException(Exception arg0) {
				}
				@Override
		...
		case R.id.btn_eugames_addiction:
			EUSDKUnify.getInstance().addictionPrevention(userId,new EUSDKListener() {
				@Override
				public void onException(Exception arg0) {
				}
				@Override
		...
		case R.id.btn_upload_updated_log:
			...
			EUSDKUnify.getInstance().postUpdatedGameLog(extendMap,MainActivity.this);
			break;
		case R.id.btn_upload_updating_log:
			extendMap.put("updateDataId", "updateDataId");
			EUSDKUnify.getInstance().postUpdatingGameLog(extendMap,MainActivity.this);
	...
	private EUSDKListener loginListener = new EUSDKListener() {
		...
		public void onComplete(Bundle bundle) {
			...
			new Thread(){
				...
				public void run() {
					try{
					EUSDKConfigParameters config = config = ConfigUtils.refineConfigMsg(MainActivity.this);
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		EUSDKUnify.getInstance().exit(MainActivity.this,
				new EUSDKListener() {
					@Override
					public void onException(Exception arg0) {
					}
